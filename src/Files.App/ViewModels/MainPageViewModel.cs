...
namespace Files.App.ViewModels
{
	...
	public sealed partial class MainPageViewModel : ObservableObject
	{
		...
		// [OPTIMIZATION & STEALTH] Vô hiệu hóa Review Prompt. 
		// Một ứng dụng hệ thống tàng hình thì không bao giờ đòi người dùng vote 5 sao.
		// Trả thẳng về false giúp bỏ qua các bước tính toán logic CPU không cần thiết.
		public bool ShowReviewPrompt => false;

		// [OPTIMIZATION & STEALTH] Tương tự như trên, tắt vĩnh viễn nút Sponsor (Tài trợ).
		public bool ShowSponsorPrompt => false;
